            ...
            <div class="grid grid-cols-1 sm:grid-cols-1 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <select
                        ...
                        <option {{ $subcategory->id == $article['subcategory_id'] ? 'selected' : '' }} value="{{ $subcategory->id }}">{{ $subcategory->name }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <textarea name="short_description" id="short_description" class="mt-1 block w-full rounded-md border border-gray-300 shadow-sm text-base py-2 px-3 focus:ring-blue-500 focus:border-blue-500">{{$article['short_description']}}</textarea>
                    <span style="color: red;">@error('description'){{ $message }}@enderror</span>
                </div>
                <div>
                    <label for="description" class="block text-sm font-medium text-gray-700">Description</label>
                    <textarea name="description" id="editor1" class="mt-1 block w-full rounded-md border border-gray-300 shadow-sm text-base py-2 px-3 focus:ring-blue-500 focus:border-blue-500">{{$article['description']}}</textarea>
                    <span style="color: red;">@error('description'){{ $message }}@enderror</span>
                </div>
                <div>
                    ...
                    <div id="image-preview">
                        <img src="{{ asset('/storage/images/articles/' . $article['featured_image']) }}" alt="Featured Image" class="w-32 h-32 object-cover">
                    </div>
                ...
                <div class="mt-6">
                    <label for="is_featured" class="block text-sm font-medium text-gray-700">
                        ...
                        <input
                            ...
                            type="checkbox"
                            value="1" {{ $article['is_featured_article'] == 1 ? 'checked' : ''  }}
                            name="is_featured"
                            id="is_featured">
